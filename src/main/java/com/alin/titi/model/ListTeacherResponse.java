...
public class ListTeacherResponse {
    ...
    private String tchCountry;
    private String tchName;
    private String tchNameEN;
    private String Sex;
    private Date tchBirthday;
    private String tchIsAboriginal;
    private String tchAboriginal;
    ...
    private String tchEstablishment;
    private String tchKind;
    private String tchKindIndustry;
    private String tchKindDepartment;
    private String tchSceWhemain_ther;
    private String tchScePurpose;
    private String tchSecUnit;
    private String tchPartAdmini;
    private String tchAdminiJob;
    private String tchSchoolType;
    ...
    private String tch106PaySalary;
    private String tch107PaySalary;
    private String tchFiestAssistant;
    private String tchFullTime;
    private String tchSixtyFive;
    private String tchTwoFour;
    private String tchComplyLaw;
    private String tchFullPartPosition;
    private String tchTow;
    ...
    public String getTchIdType() {
        return tchIdType;
    }

    public void setTchIdType(String tchIdType) {
        this.tchIdType = tchIdType;
    }

    public String getTchIdNumberI() {
        return tchIdNumberI;
    }

    public void setTchIdNumberI(String tchIdNumberI) {
        this.tchIdNumberI = tchIdNumberI;
    }

    public String getTchCountry() {
        return tchCountry;
    }

    public void setTchCountry(String tchCountry) {
    ...
    public String getTchIsAboriginal() {
        return tchIsAboriginal;
    }

    public void setTchIsAboriginal(String tchIsAboriginal) {
        this.tchIsAboriginal = tchIsAboriginal;
    }

    public String getTchAboriginal() {
        return tchAboriginal;
    }

    public void setTchAboriginal(String tchAboriginal) {
    ...
    public String getTchEstablishment() {
        return tchEstablishment;
    }

    public void setTchEstablishment(String tchEstablishment) {
        this.tchEstablishment = tchEstablishment;
    }

    public String getTchKind() {
        return tchKind;
    }

    public void setTchKind(String tchKind) {
        this.tchKind = tchKind;
    }

    public String getTchKindIndustry() {
        return tchKindIndustry;
    }

    public void setTchKindIndustry(String tchKindIndustry) {
    ...
    public String getTchSceWhemain_ther() {
        return tchSceWhemain_ther;
    }

    public void setTchSceWhemain_ther(String tchSceWhemain_ther) {
    ...
    public String getTchSchoolType() {
        return tchSchoolType;
    }

    public void setTchSchoolType(String tchSchoolType) {
    ...
    public String getTchRireYear() {
        return tchRireYear;
    }

    public void setTchRireYear(String tchRireYear) {
    ...
    public String getTch106PaySalary() {
        return tch106PaySalary;
    }

    public void setTch106PaySalary(String tch106PaySalary) {
        this.tch106PaySalary = tch106PaySalary;
    }

    public String getTch107PaySalary() {
        return tch107PaySalary;
    }

    public void setTch107PaySalary(String tch107PaySalary) {
        this.tch107PaySalary = tch107PaySalary;
    }

    public String getTchFiestAssistant() {
        return tchFiestAssistant;
    }

    public void setTchFiestAssistant(String tchFiestAssistant) {
        this.tchFiestAssistant = tchFiestAssistant;
    }

    public String getTchFullTime() {
        return tchFullTime;
    }

    public void setTchFullTime(String tchFullTime) {
        this.tchFullTime = tchFullTime;
    }

    public String getTchSixtyFive() {
        return tchSixtyFive;
    }

    public void setTchSixtyFive(String tchSixtyFive) {
        this.tchSixtyFive = tchSixtyFive;
    }

    public String getTchTwoFour() {
        return tchTwoFour;
    }

    public void setTchTwoFour(String tchTwoFour) {
        this.tchTwoFour = tchTwoFour;
    }

    public String getTchComplyLaw() {
        return tchComplyLaw;
    }

    public void setTchComplyLaw(String tchComplyLaw) {
    ...
    public String getTchTow() {
        return tchTow;
    }

    public void setTchTow(String tchTow) {
        this.tchTow = tchTow;
    }

    public String getTchIdNumberR() {
        return tchIdNumberR;
    }

    public void setTchIdNumberR(String tchIdNumberR) {
        this.tchIdNumberR = tchIdNumberR;
    }

    public String getTchIdNumberP() {
        return tchIdNumberP;
    }

    public void setTchIdNumberP(String tchIdNumberP) {
